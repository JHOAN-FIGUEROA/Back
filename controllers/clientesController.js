...
// Función mejorada para enviar correo en HTML
...
const clientesController = {
    ...
    async obtenerClientes(req, res) {
        try {
            ...
            // Formatear los clientes para asegurar una serialización correcta
    ...
    async obtenerTodosClientes(req, res) {
        try {
            const search = req.query.search || '';
            ...
            return ResponseHandler.error(res, 'Error interno', 'Error al obtener todos los clientes');
        }
    },
    ...
    async obtenerCliente(req, res) {
        try {
            const { id } = req.params;
            const { incluirVentas } = req.query; // Parámetro opcional para incluir ventas
            ...
            // Formatear la respuesta base del cliente
            ...
            // Si se solicita incluir ventas, obtener el historial
    ...
    async crearCliente(req, res) {
        try {
            ...
            // Crear cliente asociado usando el mismo documento como ID
            ...
            // Formatear el cliente creado para asegurar una serialización correcta
            const clienteFormateado = {
    ...
    async actualizarCliente(req, res) {
        try {
            ...
            // Obtener el cliente actualizado con su usuario
    ...
    async eliminarCliente(req, res) {
        try {
            ...
            // Si el cliente tiene un usuario asociado, eliminarlo también
            if (cliente.usuario) {
